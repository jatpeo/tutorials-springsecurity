...
/*
* 演示 spring security授权操作
* */
//@EnableWebSecurity
public class SecurityConfig_5 extends WebSecurityConfigurerAdapter {
...
//    }
    ...
    protected UserDetailsService userDetailsService() {
        ...
        manager.createUser(User.withUsername("B").password("456").roles("user").build());
        return manager;
    }
