...
import com.jpp.demo.withjpa.bean.JSONResult;
...
/*
* 演示 07、Spring Security 与Spring Data JPA 联手
*
* */
//@EnableWebSecurity
public class SecurityConfig_7 extends WebSecurityConfigurerAdapter {
    ...
    LoginFilter loginFilter() throws Exception{
        ...
        loginFilter.setAuthenticationSuccessHandler(new AuthenticationSuccessHandler() {
            ...
            public void onAuthenticationSuccess(HttpServletRequest request,
                ...
                JSONResult ok = JSONResult.build(200,"登录成功!", user); //登录成功
